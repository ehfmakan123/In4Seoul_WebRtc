<template>
  <div>
    <!-- 모달들 먼저 선언 -->
    <post-password-form :postId="selectedPost.id" @password-correct="editPost"></post-password-form>
    <post-update-form :post="selectedPost"></post-update-form> 
    <!-- @try-delete="tryDelete" @try-unsave-close="tryUnsaveClose" -->
      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content postit">
          ...
          <div class="modal-footer">
            <button @click="tryEdit" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#passwordModal">편집</button>
