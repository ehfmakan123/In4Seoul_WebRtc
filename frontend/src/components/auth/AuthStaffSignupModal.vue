      ...
      <div class="modal-content bd-blue-4 px-4 pt-3 pb-4">
        ...
        <div class="modal-body">
          <div class="input-group">
            ...
            <input type="text" class="form-control bd-blue-3" placeholder="" aria-label="staff-signup-id" aria-describedby="staff-signup-id" v-model="staffSignupCredentials.id">
          ...
          <div class="input-group mt-4">
            ...
            <input type="password" class="form-control bd-blue-3" placeholder="" aria-label="staff-signup-password-confirm" aria-describedby="staff-signup-password-confirm" v-model="staffSignupCredentials.passwordConfirm">
          </div>
          <div class="input-group mt-4">
...
export default {
  ...
  setup() {
    ...
    const staffSignupCancel = () => {
      staffSignupCredentials.value.id = ""
      staffSignupCredentials.value.password = ""
      staffSignupCredentials.value.passwordConfirm = ""
